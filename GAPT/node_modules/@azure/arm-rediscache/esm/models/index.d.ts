 ...
 * @enum {string}
 */
export declare type SkuFamily = 'C' | 'P';
/**
 ...
 * @enum {string}
 */
export declare type ProvisioningState = 'Creating' | 'Deleting' | 'Disabled' | 'Failed' | 'Linking' | 'Provisioning' | 'RecoveringScaleFailure' | 'Scaling' | 'Succeeded' | 'Unlinking' | 'Unprovisioning' | 'Updating';
/**
 ...
 * @enum {string}
 */
export declare type RebootType = 'PrimaryNode' | 'SecondaryNode' | 'AllNodes';
/**
 ...
 * Contains response data for the list operation.
 */
export declare type RedisListResponse = RedisListResult & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type RedisForceRebootResponse2 = RedisForceRebootResponse & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type RedisBeginCreateResponse = RedisResource & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listNext operation.
 */
export declare type RedisListNextResponse = RedisListResult & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type FirewallRulesListByRedisResourceResponse = RedisFirewallRuleListResult & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type FirewallRulesListByRedisResourceNextResponse = RedisFirewallRuleListResult & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreate operation.
 */
export declare type LinkedServerBeginCreateResponse = RedisLinkedServerWithProperties & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
